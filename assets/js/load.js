(function (window, undefined){
	...
	AcceptCookie.prototype = {
		...
		addCookieBar: function(){
			...
			htmlBar += '<p>Usamos cookies para garantizar que le brindemos la mejor experiencia en nuestro sitio web. <br /> Al cerrar este mensaje, acepta nuestras cookies en este dispositivo de acuerdo con nuestra política de cookies a menos que las haya deshabilitado.</p>';
			htmlBar += '<div class="pjAcceptCookieBarActions">';
			htmlBar += '<button type="button" class="pjAcceptCookieBarBtn">Aceptar!</button>';
			htmlBar += '</div>';
			htmlBar += '</form>';
			htmlBar += '</div>';
